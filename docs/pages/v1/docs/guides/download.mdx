...
In the most basic version, nothing else than the did of the asset to be accessed is needed. You can find more detailed information at the [`nautilus.access()`](/v1/docs/api/nautilus/access) docs.
...
- [`nautilus.access()`](/v1/docs/api/nautilus/access) - API documentation of the access function
