...
Note, that if required, there is a lot more that can be customized. To learn more about the API head over to the detailed [`AssetBuilder` documentation](/v1/docs/api/AssetBuilder).
...
```
> **_NOTE:_** There are multiple supported [ServiceTypes](/v1/docs/api/ServiceBuilder#servicetypes) and [FileTypes](/v1/docs/api/ServiceBuilder#filetypes)
...
If you want to learn more about the API and everything you can configure, head over to the detailed [`ServiceBuilder` documentation](/v1/docs/api/ServiceBuilder).
...
- [`AssetBuilder`](/v1/docs/api/AssetBuilder) - API overview for building asset metadata
- [`ServiceBuilder`](/v1/docs/api/ServiceBuilder) - To build service MediaMetadata, you have access to a dedicated API
- [`ConsumerParameterBuilder`](/v1/docs/api/ConsumerParameterBuilder) - Your service requires custom userdata to work? Head here for additional info.
- [`nautilus.publish()`](/v1/docs/api/nautilus/publish) - API documentation for the `nautilus.publish()` call
