...
To learn more about how to check the status of an ongoing compute job, read the [`getComputeStatus` documentation](/v1/docs/api/nautilus/getComputeStatus).
...
This inherits the properties of the [`ComputeStatusConfig`](/v1/docs/api/nautilus/getComputeStatus#config)
