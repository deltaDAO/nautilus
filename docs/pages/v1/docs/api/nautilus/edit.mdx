...
If you want to learn more about how to build your metadata using nautilus' builder classes, the [`AssetBuilder` documentation](/v1/docs/api/AssetBuilder) is a good place to start.
...
[`PublishResponse`](/v1/docs/api/PublishResponse) {/*link to type in docs if possible*/}
...
Refer to the [`AssetBuilder`](/v1/docs/api/AssetBuilder) documentation for more information on how to construct assets.