...
If you want to learn more about how you can specify these custom parameters for your assets, you can find more information on the [`ConsumerParameterBuilder` documentation](/docs/pi/ConsumerParameterBuilder).
