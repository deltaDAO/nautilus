...
Starting a new compute job can be very quick to achieve. The most basic configuration needs only the identifiers of both the dataset and algorithm. You can use a [`ComputeConfig`](/docs/api/ComputeConfig) to configure this call.
...
- [`ComputeConfig`](/docs/api/ComputeConfig) - A look at how to configure compute calls
- [`ComputeStatusConfig`](/docs/api/ComputeStatusConfig) - Explainers for compute status configurations
- [`ComputeResultConfig`](/docs/api/ComputeResultConfig) - How to request compute results
